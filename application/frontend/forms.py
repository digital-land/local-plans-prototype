...
from wtforms import StringField, validators, IntegerField, HiddenField, SelectMultipleField, DateField
...
class AddPlanForm(FlaskForm):
	...
	local_development_framework_number = IntegerField('Local development framework number', [validators.Optional()])
